---
title: "<center> BIOS 612: Advanced GLM,Assignemnt 2 </center>"
author: ""
date: "`r Sys.Date()`"
output: 
  html_document:
...
#Scater plot of the data before we begin modelling 
length.no.NA <- function (x) sum(!is.na(x))
...
#plot the prediction of the outcome using the MLE method model
library(ggplot2)
